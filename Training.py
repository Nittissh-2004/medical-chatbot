...
for intent in intents['intents']:
    ...
    words = [lemmatizer.lemmatizer(w.lower())for w in words if w not in ignore_words]
    ...
    for doc in documents:
       ...
       #equal to number of intents to pradict output intent with softmax
       model = sequential()
       ...
       hist = model.fit(np.array(train_y),epochs=300,batch_size=5,verbose=1)
